...
@interface CJLPopoverView ()<UITableViewDataSource, UITableViewDelegate>
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.borderColor = [UIColor colorWithRed:0.44 green:0.65 blue:0.77 alpha:1];
